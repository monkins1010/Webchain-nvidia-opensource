...
public:
	...
	constexpr static const char *kDefaultWorkerId = "AMD";
	...
	inline const char *workerId() const		 { return m_workerId ? m_workerId : kDefaultWorkerId; }
	...
	inline void setWorkerId(const char *workerId) { m_workerId = (char*)workerId; }
