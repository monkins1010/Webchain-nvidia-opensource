...
#   endif
	...
	Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\ $$\\       $$$$$$\\  $$\\   $$\\ $$$$$$$\\  " : "s");
	Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\ $$ |     $$  __$$\\ $$ |  $$ |$$  __$$\\" : "s");
	Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\ $$ |     $$ /  $$ |$$ |  $$ |$$ |  $$ |" : "s");
	Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\ $$ |     $$ |  $$ |$$ |  $$ |$$ |  $$ |" : "s");
    Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\ $$ |     $$ |  $$ |$$ |  $$ |$$ |  $$ |" : "s");
	Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\ $$ |     $$ |  $$ |$$ |  $$ |$$ |  $$ |" : "s");
	Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\ $$$$$$$$\\ $$$$$$  |\\$$$$$$  |$$$$$$$  |" : "s");
	Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\ \\________|\\______/  \\______/ \\_______/ Mining" : "s ");
	Log::i()->text(Options::i()->colors() ? "\x1B[01;32m\            by Monkins1010" : "s ");


    Log::i()->text(Options::i()->colors() ? "\x1B[01;32m * \x1B[01;37mVERSIONS:     \x1B[01;36mXMRig-Monkins1010/%s\x1B[01;37m libuv/%s CUDA/%d.%d%s" : " * VERSIONS:     XMRig/%s libuv/%s CUDA/%d.%d%s",
